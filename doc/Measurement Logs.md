...
**Branch**
```
emailmeasurement-structured-input
```
**Tag**
```
v1.2
...
**Measurement Name**
```
EMail Ollama Measurement Deepseek 1.5B v1.2
```
**usage_scenario file**
```
...
**Measurement Name**
```
EMail Ollama Measurement Llama 3.2 3B v1.2
```
**usage_scenario file**
```
...
**Measurement Name**
```
EMail Ollama Measurement Llama 3.2 1B v1.2
```
**usage_scenario file**
```
...
**Measurement Name**
```
EMail Ollama Measurement Gemma 3 4b v1.2
```
**usage_scenario file**
```
...
**Measurement Name**
```
EMail Ollama Measurement Gemma3 1b v1.2
```
**usage_scenario file**
```
...
**Measurement Name**
```
EMail Ollama Measurement Gemma 3 270M v1.2
```
**usage_scenario file**
```
